...
-- =====================================================================
-- ★ [SEC-6 HARDENING] YAMA NOTU: Bu blok önceden AYNEN İKİ KEZ vardı --
-- [2]/[2a]/[3]/[3a] etiketli birinci kopya, aşağıdaki [FAZ 1]/[FAZ 4]
-- etiketli ikinci kopyanın DAHA ZAYIF bir öncülüydü (cooldown YOKTU).
-- Lua'da aynı isimli fonksiyonun ikinci tanımı ilkinin üzerine yazar, AMA
-- RegisterNetEvent İKİ AYRI HANDLER kaydeder -- bu yüzden
-- 'matrix:server:phone:remoteWipe' event'i tetiklendiğinde BİRİNCİ
-- (cooldown'suz) handler İKİNCİ (cooldown korumalı) handler'ın YANINDA
-- HALA çalışıyordu. Sonuç: bir hilekar cooldown'u round-trip zamanlamasıyla
-- bypass edip spam/DoS yapabiliyordu -- bu, görevin "command spoofing"
-- istismar yüzeyinin somut bir örneğiydi. Birinci kopya TAMAMEN kaldırıldı;
-- tek otorite artık aşağıdaki [FAZ 1]/[FAZ 4] bloğudur.
-- =====================================================================
